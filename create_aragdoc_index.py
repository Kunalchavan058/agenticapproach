"""
Script to create an Azure AI Search indexing for the 'aragdoc' folder.
"""
...
EMBEDDING_MODEL = os.environ.get("AZURE_OPENAI_EMBEDDING_DEPLOYMENT", os.environ.get("AZURE_AI_EMBEDDING_MODEL"))
